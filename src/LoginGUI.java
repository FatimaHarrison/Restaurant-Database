...
public class LoginGUI extends JFrame {
    ...
    public LoginGUI() {
        ...
        // Prompt for database path before login
        String dbPath = promptForDatabasePath();
        if (dbPath != null) {
    ...
    private String promptForDatabasePath() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            if (file.getName().endsWith(".db") || file.getName().endsWith(".sqlite")) {
                ...
                JOptionPane.showMessageDialog(this, "Invalid file type. Please select a .db or .sqlite file.");
            }
        }
        return null;
    }
