...
public class HostMenuGUI extends JFrame {
    ...
    private final List<String> logLines = new ArrayList<>();//Used to read each lines from loaded file.
...
//GUI menu setup
    ...
    public HostMenuGUI() {
     ...
     /**
      * Loads a reservation database file selected by the user opened from a dialog.
      * Reads the file line-by-line and stores its contents in logLines.
      * Displays a file load success or error message based on the outcome.
      */
        //Loading file
        loadDataButton.addActionListener(e -> {
            ...
            if (result == JFileChooser.APPROVE_OPTION) {//Approved if file end in .db or .sqlite
                ...
                logLines.clear();//Reloading and filtering logs
