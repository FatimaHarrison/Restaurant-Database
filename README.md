# Restaurant-Database
User will now interact with the backend verson to this newly implemented Sqlite database from using the GUI menu in CRUD and custom functions. 
Each menu has it's own CRUD function in which not all will create, read, uodate, and delete data at once. 
The auditLog custom function requries the user to input a start and end date for a specfic data to be serach in the table.
